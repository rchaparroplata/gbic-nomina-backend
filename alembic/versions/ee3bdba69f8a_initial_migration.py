...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_bancos_id_banco'), 'bancos', ['id_banco'], unique=False)
    ...
    op.create_index(op.f('ix_colonias_id_colonia'), 'colonias', ['id_colonia'], unique=False)
    ...
    sa.Column('activo', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['id_colonia'], ['colonias.id_colonia'], ),
    ...
    sa.ForeignKeyConstraint(['id_usuario'], ['users.id_user'], ),
    sa.PrimaryKeyConstraint('id_ajuste')
    )
    op.create_index(op.f('ix_ajustes_id_ajuste'), 'ajustes', ['id_ajuste'], unique=False)
